...
function onProgress(e) {
    var progress = Math.floor((e.loaded / wordpressHybridClient.js.size || 0) * 100);
    document.getElementById('appLoader').setAttribute("value", progress);
    document.getElementById('appLoaderPourcent').innerText = document.createTextNode(progress).textContent;
}
